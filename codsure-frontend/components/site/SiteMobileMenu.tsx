...
export function SiteMobileMenu() {
    ...
    return (
        <div className="md:hidden">
            ...
            {open && (
                <div className="fixed inset-0 z-[100] flex flex-col bg-white/100 backdrop-blur-none text-slate-900 animate-in slide-in-from-top duration-200 shadow-2xl h-screen">
